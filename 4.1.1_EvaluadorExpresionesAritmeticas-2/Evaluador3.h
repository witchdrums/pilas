...
public:
	...
	void evaluar(int i, int numOperaciones){
		if (i == numOperaciones){
			cout<<"evaluar.return.pila.getCima: "<<postfija.getCima()<<endl;
			...
			if ( !isNum( postfija.getCima(), 0, postfija.getCima().size() ) ){
				cout<<"evaluar.!isNum(): "<<postfija.getCima()<<endl;
				pila.push( postfija.getCima() );
				postfija.pop();
				cout<<"evaluar.isNum().postfija: ";
				desplegarPostfija();
				cout<<endl;
			}else{
				cout<<"evaluar.isNum(): "<<postfija.getCima()<<endl;
	...
	float operar(){
		operacion = pila.getCima();
		pila.pop();
		cout<<"operar.operacion: "<<operacion<<endl;
		cout<<"operar.postfija.getCima(): "<<postfija.getCima()<<endl;
